...
def generate_market_data():
    ...
    if total_cards == 0:
        print("error: silver_cards table is empty.")
        return
    ...
    try:
        ...
        print(f"generating {total_expected_rows} prices...")
        ...
        with open(MARKET_PRICES_FILE, mode='w', encoding='utf-8', newline='') as f:
            ...
            for card_id, set_id, name in db_cards:
                ...
                if generated_count % 100000 == 0:
                    print(f"progress: {generated_count}/{total_expected_rows}")
    
        print(f"done: {generated_count} records saved.")
